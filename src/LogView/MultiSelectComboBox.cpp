...
void MultiSelectComboBox::stateChanged(int aState)
{
    ...
    for (int i = 1; i < count; ++i)
    {
        ...
        if (checkBox->isChecked())
        {
            ...
            mCurrentData.append(itemData(i));
        }
    }
...
QVariantList MultiSelectComboBox::currentData()
{
    return mCurrentData;
}
...
QAction *MultiSelectComboBox::AddAction(const QIcon &icon)
{
    return mLineEdit->addAction(icon, QLineEdit::TrailingPosition);
}
