...
if(NOT ZLIB_LIBRARY)
  ...
  foreach(search ${_ZLIB_SEARCHES})
    if(ZLIB_USE_STATIC_LIBS)
      ...
      find_library(ZLIB_IMPLIB_RELEASE NAMES ${ZLIB_NAMES} NAMES_PER_DIR ${${search}} PATH_SUFFIXES lib)
      find_library(ZLIB_IMPLIB_DEBUG NAMES ${ZLIB_NAMES_DEBUG} NAMES_PER_DIR ${${search}} PATH_SUFFIXES lib)
      set(CMAKE_FIND_LIBRARY_SUFFIXES .dll)
      find_library(ZLIB_LIBRARY_RELEASE NAMES ${ZLIB_NAMES} NAMES_PER_DIR ${${search}} PATH_SUFFIXES bin)
      find_library(ZLIB_LIBRARY_DEBUG NAMES ${ZLIB_NAMES_DEBUG} NAMES_PER_DIR ${${search}} PATH_SUFFIXES bin)
    endif()
  endforeach()
...
message(STATUS "ZLIB found: headers in ${ZLIB_INCLUDE_DIRS}, library: ${ZLIB_LIBRARY}")
